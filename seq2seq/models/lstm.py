...
class LSTMDecoder(Seq2SeqDecoder):
    ...
    def __init__(self,
        ...
        if self.use_lexical_model:
            ...
            self.lexical_output_projection = nn.Linear(embed_dim, len(dictionary))
    ...
    def forward(self, tgt_inputs, encoder_out, incremental_state=None):
        ...
        for j in range(tgt_time_steps):
            ...
            if self.attention is None:
                ...
                if self.use_lexical_model:
                    ...
                    # Project lexical context vector
        ...
        if self.use_lexical_model:
            ...
            # Compute lexical model predictions
            ...
            decoder_output = decoder_output + self.lexical_output_projection(lexical_contexts)
